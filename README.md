---
### 과제 요구사항을 분석한 문서를 `KB헬스케어_과제_분석자료.pdf` 로 정리하였고, 해당 내용을 바탕으로 전체 시스템을 설계 및 구현하였습니다.
### 현재 사용 중인 네트워크 보안 정책으로 인해 Gmail을 통한 파일 첨부가 제한되어, 제출 마감 시각이 임박한 상황에서 부득이하게 GitHub에 압축 파일을 업로드하게 되었습니다. 양해 부탁드립니다.
### `KB헬스케어_백엔드_과제_제출_최종현.zip` 파일을 다운로드하여 확인해 주시면 감사하겠습니다.
---
